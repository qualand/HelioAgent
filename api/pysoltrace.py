...
class PySolTrace:
    ...
    def __load_dll(self):
        ...
        if sys.platform == 'win32' or sys.platform == 'cygwin':
            ...
            # CDLL("C:/SolTrace_embree_beta/3.4.0/api/embree4.dll")
            # pdll = CDLL("C:/SolTrace_embree_beta/3.4.0/api/coretrace_api.dll")
            CDLL(cwd + "/api/embree4.dll")
            pdll = CDLL(cwd + "/api/coretrace_api.dll")
            # print("Loaded win32")
